...
def randomizedMotifSearch(dna, k, t):
    ...
    while 1:
        ...
        motifs = []
        for seq in dna:        
            motifi = profileMostProbableKmer(seq, k, profileMatrixEdited)
...
#f = open("C:/Users/karim.afifi/Desktop/Bioinformatics Specialization/Finding Hidden Messages in DNA (Bioinformatics I)/Week 4/dataset_161_5.txt", "r")
#data = f.readlines()
#f.close()
#k = 0
#t = 0
...
#for i in range(50):
#    if i == 0:
#        minMotifs = randomizedMotifSearch(dnaStrings, k, t)
#    else:
#        foundMotifs = randomizedMotifSearch(dnaStrings, k, t)
