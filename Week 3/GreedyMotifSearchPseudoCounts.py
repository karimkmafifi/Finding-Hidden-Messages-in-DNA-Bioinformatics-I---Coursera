...
def greedyMotifSearch(dna, k, t):
    ...
    for i in range(len(dna[0])-k+1):
        ...
        for j in range(1, t):
            profileMatrix = createProfileMatrixPseudoCount(lstMotifs)
            profileMatrixEdited = []
...
#f = open("C:/Users/karim.afifi/Desktop/Bioinformatics Specialization/Finding Hidden Messages in DNA (Bioinformatics I)/Week 3/dataset_160_9.txt", "r")
#data = f.readlines()
#k = 0
#t = 0
#dnaStrings = []
